...
import { Users, CheckCircle, AlertTriangle, XCircle, Clock, Target, TrendingDown, TrendingUp, Minus } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const upcomingActions = actions
    .filter(a => a.nextActionDate && a.nextActionDate >= todayStr && a.isCompleted === undefined)
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex flex-col justify-between">
            ...
            <div className="flex items-end justify-between">
              ...
              <div className="text-sm text-gray-500 font-medium">Цель: ≥ 90%</div>
            </div>
          </div>

          {/* KPI 2 */}
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex flex-col justify-between">
            <div className="text-sm font-medium text-gray-500 mb-2">% прохождения (макс. 2 блока отст.)</div>
            <div className="flex items-end justify-between">
              <div className={`text-3xl font-bold ${progressingPercent >= 75 ? 'text-green-600' : 'text-red-600'}`}>
                {progressingPercent}%
              </div>
              <div className="text-sm text-gray-500 font-medium">Цель: ≥ 75%</div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex flex-col justify-between">
            ...
            <div className="flex items-end justify-between">
              ...
              <div className="text-sm text-gray-500 font-medium">Цель: ≤ 10%</div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6 lg:col-span-1">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Следующий звонок</h2>
                ...
                return (
                  <li key={action.id} className="py-4">
                    <div className="flex justify-between items-start">
                      <p className="text-sm font-medium text-gray-900 truncate pr-4" title={student?.email}>
